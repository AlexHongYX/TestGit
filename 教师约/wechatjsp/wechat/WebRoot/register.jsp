						...
						<form id="member-registration" action="register_deal.jsp"
							...
							<fieldset>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<!-- 账户文本框 -->
										<input type="text" name="username" id="username" placeholder="请输入账户名称"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<!-- 确认密码文本框 -->
										<input type="password" name="pwd2" id="pwd2" placeholder="请再次输入确认密码"
											autocomplete="off" class="validate-password required"
											size="38" maxlength="99" required="required"
											aria-required="true"><span class="star">&nbsp;*</span>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										...
										placeholder=" " size="38" aria-required="true">
									</div>
								</div>
